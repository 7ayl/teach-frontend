...
// ../../node_modules/.pnpm/ink-mde@0.18.1_vue@3.2.47/node_modules/ink-mde/dist/lists.b465ff74.js
var dotWidget = () => {
  return {
    compare: (_other) => {
      return false;
...
var hasOverlap = (x1, x2, y1, y2) => {
  return Math.max(x1, y1) <= Math.min(x2, y2);
};
var isCursorInRange = (state, from, to) => {
  return state.selection.ranges.some((range) => {
    return hasOverlap(from, to, range.from, range.to);
  });
};
var toggleTask = (view, position) => {
...
//# sourceMappingURL=lists.b465ff74-O6BOGDJW.js.map
